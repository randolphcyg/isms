...
type Data struct {
	...
	Openapi       *Data_Openapi          `protobuf:"bytes,3,opt,name=openapi,proto3" json:"openapi,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Data) GetOpenapi() *Data_Openapi {
	if x != nil {
		return x.Openapi
	}
	return nil
...
type Data_Database struct {
	...
	Host     string                 `protobuf:"bytes,2,opt,name=host,proto3" json:"host,omitempty"`         // 数据库主机
	...
	User     string                 `protobuf:"bytes,5,opt,name=user,proto3" json:"user,omitempty"`         // 用户名
	...
	ConnMaxLifetime *durationpb.Duration `protobuf:"bytes,9,opt,name=conn_max_lifetime,json=connMaxLifetime,proto3" json:"conn_max_lifetime,omitempty"`    // 连接最大生命周期
...
func (x *Data_Openapi) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Data_Openapi) ProtoMessage() {}

func (x *Data_Openapi) ProtoReflect() protoreflect.Message {
	mi := &file_conf_conf_proto_msgTypes[7]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Data_Openapi.ProtoReflect.Descriptor instead.
func (*Data_Openapi) Descriptor() ([]byte, []int) {
	return file_conf_conf_proto_rawDescGZIP(), []int{2, 2}
}

func (x *Data_Openapi) GetPath() string {
	if x != nil {
		return x.Path
	}
	return ""
...
const file_conf_conf_proto_rawDesc = "" +
	...
	"\aopenapi\x18\x03 \x01(\v2\x18.kratos.api.Data.OpenapiR\aopenapi\x1a\xf1\x02\n" +
	"\bDatabase\x12\x16\n" +
	...
	" \x01(\v2\x19.google.protobuf.DurationR\x0fconnMaxIdleTime\x1a\xb3\x01\n" +
	"\x05Redis\x12\x18\n" +
	"\anetwork\x18\x01 \x01(\tR\anetwork\x12\x12\n" +
	"\x04addr\x18\x02 \x01(\tR\x04addr\x12<\n" +
	"\fread_timeout\x18\x03 \x01(\v2\x19.google.protobuf.DurationR\vreadTimeout\x12>\n" +
	"\rwrite_timeout\x18\x04 \x01(\v2\x19.google.protobuf.DurationR\fwriteTimeout\x1a\x1d\n" +
	"\aOpenapi\x12\x12\n" +
	"\x04path\x18\x01 \x01(\tR\x04pathB\x19Z\x17isms/internal/conf;confb\x06proto3"
...
var file_conf_conf_proto_goTypes = []any{
	...
	(*Data_Openapi)(nil),        // 7: kratos.api.Data.Openapi
...
var file_conf_conf_proto_depIdxs = []int32{
	...
	7,  // 6: kratos.api.Data.openapi:type_name -> kratos.api.Data.Openapi
	...
	8,  // 10: kratos.api.Data.Database.conn_max_idle_time:type_name -> google.protobuf.Duration
